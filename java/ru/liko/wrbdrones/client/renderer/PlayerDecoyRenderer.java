 ...
 * Отображает декой как полноценную модель игрока с скином, бронёй и предметами в руках.
 */
public class PlayerDecoyRenderer extends LivingEntityRenderer<PlayerDecoyEntity, PlayerModel<PlayerDecoyEntity>> {
    ...
    public PlayerDecoyRenderer(EntityRendererProvider.Context context, boolean slim) {
        ...
        this.addLayer(new HumanoidArmorLayer<>(this,
                new net.minecraft.client.model.HumanoidModel<>(context.bakeLayer(slim ? ModelLayers.PLAYER_SLIM_INNER_ARMOR : ModelLayers.PLAYER_INNER_ARMOR)),
                new net.minecraft.client.model.HumanoidModel<>(context.bakeLayer(slim ? ModelLayers.PLAYER_SLIM_OUTER_ARMOR : ModelLayers.PLAYER_OUTER_ARMOR)),
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull PlayerDecoyEntity entity) {
        ...
        // Загружаем скин асинхронно через SkinManager
        var skinManager = mc.getSkinManager();
        ...
        // Возвращаем дефолтный скин пока загружается
