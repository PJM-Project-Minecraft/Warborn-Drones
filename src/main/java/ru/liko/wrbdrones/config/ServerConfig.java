...
public class ServerConfig {
    ...
    public static void init(ModConfigSpec.Builder builder) {
        ...
        builder.comment("Maximum distance (blocks) at which FPV/Mavic drone engine sound can be heard. Set to 0 for no limit");
        FPV_SOUND_MAX_DISTANCE = builder.defineInRange("fpv_max_distance", 250.0, 0.0, 5000.0);
