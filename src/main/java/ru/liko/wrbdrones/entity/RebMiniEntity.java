...
public class RebMiniEntity extends Entity implements GeoEntity {
    private static final EntityDataAccessor<Boolean> IS_ENABLED = SynchedEntityData.defineId(RebMiniEntity.class,
            EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> HEALTH = SynchedEntityData.defineId(RebMiniEntity.class,
        ...
        if (player.isShiftKeyDown()) {
            ...
            if (!this.level().isClientSide()) {
                if (!player.getAbilities().instabuild) {
                    player.getInventory().placeItemBackInInventory(new ItemStack(ModItems.REB_MINI.get()));
                }
                this.discard();
            }
